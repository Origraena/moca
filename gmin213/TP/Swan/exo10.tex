...
Existe-t-il une k-partition $O_1,...,O_k TODO O$ telle que :
\begin{itemize}
...
De plus, puisque les $O_i$ sont disjoints, nous avons $B = B(0_1)+B(O_2)+B(O_3)+B(0_4)$,
...
En particulier nous avons : $B(O_1)+B(O_2) > 1$ et $B(O_3)+B(0_4) > 1$, c'est à dire :
