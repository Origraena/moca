...
Nous obtenons un nœud de l'arbre et une solution entière admissible. Nous devons maintenant développer le reste de l'arbre pour vérifier s'il est possible d'obtenir une meilleure solution entière. Posons donc la contrainte suivante : $x_2 \geq 1$.
...
Dans cette solution, $x_1$ n'est pas entier, on ajoute donc une contrainte : $x_1 \leq 2$.
