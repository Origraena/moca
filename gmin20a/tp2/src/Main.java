...
public class Main {
	...
	public static void main(String args[]) {
		...
		if (args.length == 0) {
			...
			TicTacToeAI tictactoeai = new TicTacToeAI(TicTacToeGrid.P2,0,true);
			...
			TicTacToeAI tictactoeai = new TicTacToeAI(TicTacToeGrid.P2,3,true);
			...
			System.out.println("Heuristique : somme de la valeur de chaque ligne, colonne, et diagonale (si un seul joueur occupe => nombre de cases remplies, sinon 0)");
			System.out.println("Grille : taille 3");
			TicTacToeAI tictactoeai = new TicTacToeAI(TicTacToeGrid.P2,3,false);
			tictactoe = new TicTacToe(new TicTacToeHuman(),tictactoeai,5);
		}
		tictactoe.run();
	}
